function Artikel_barista() {
    return (
        ...
        <div className="container">
            <div className="row">
                <div className="col-8">
            <p>Peran seorang barista di sebuah coffee shop sudah seperti ujung tombak. Barista lah yang akan meracik dan menyajikan minuman kopi terbaik kepada pelanggan. Di tangan barista pula reputasi coffee shop akan bergerak naik atau turun.</p>
            <br />
            <p>
...
export default Artikel_barista;